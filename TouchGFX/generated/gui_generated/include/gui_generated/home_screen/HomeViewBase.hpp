...
protected:
    ...
    touchgfx::Button Consultation_Button;
    touchgfx::Button Parametres_Button;
    touchgfx::Button SpO2_Button;
    touchgfx::Button Temperature_Button;
    touchgfx::Button ECG_Button;
