...
struct TypographyFontIndex
{
    ...
    static const touchgfx::FontId MEDIUM = 3;   // verdana_15_4bpp
    static const touchgfx::FontId DISPLAY = 4;  // RobotoCondensed_Regular_23_4bpp
    static const touchgfx::FontId KEYBOARD = 5; // RobotoCondensed_Regular_12_4bpp
    static const touchgfx::FontId MODE = 6;     // RobotoCondensed_Regular_15_4bpp
